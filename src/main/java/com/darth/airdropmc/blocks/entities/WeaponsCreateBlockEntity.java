...
public class WeaponsCreateBlockEntity extends RandomizableContainerBlockEntity{
	private NonNullList<ItemStack> items = NonNullList.withSize(27, ItemStack.EMPTY);
	   private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
	      protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
	    	  WeaponsCreateBlockEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
	    	  WeaponsCreateBlockEntity.this.updateBlockState(p_155064_, true);
	      }

	      protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
	         WeaponsCreateBlockEntity.this.playSound(p_155074_, SoundEvents.BARREL_CLOSE);
	         WeaponsCreateBlockEntity.this.updateBlockState(p_155074_, false);
	      }
	      ...
	      protected boolean isOwnContainer(Player p_155060_) {
	         if (p_155060_.containerMenu instanceof ChestMenu) {
	            ...
	            return container == WeaponsCreateBlockEntity.this;
	         } else {
	            return false;
	         }
	      }
	   ...
	   public WeaponsCreateBlockEntity(BlockPos p_155052_, BlockState p_155053_) {
	      super(ModBlockEntities.WEAPONS_CREATE_BE.get(), p_155052_, p_155053_);
	   }
